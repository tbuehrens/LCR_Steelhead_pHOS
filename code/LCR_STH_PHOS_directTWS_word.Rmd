...
Figure 1 shows the annual pHOS estimates for each population (or sub-population for Kalama below KFH and NF Toutle Green only) based on the GAM model with method of moment estimates plotted for comparison.
